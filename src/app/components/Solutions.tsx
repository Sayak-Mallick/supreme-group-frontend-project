...
import { motion, useScroll, useTransform, type MotionValue, AnimatePresence, easeInOut } from 'framer-motion';
...
const vehicleSectionsData = [
  {
    ...
    videoSrc: '/solution/PassengerAlpha01.mp4',
    bottomControlsData: [
      {
        name: 'Complete Body',
        image: '/icons/complete-body.png',
        video: '/solution/PassengerAlpha01.mp4',
      },
      {
        name: 'Front',
        image: '/icons/front-body.png',
        video: '/solution/PassengerFront.mp4',
      },
      {
        name: 'Cabin',
        image: '/icons/cabin.png',
        video: '/solution/PassengerCabin.mp4',
      },
      {
        name: 'Trunk',
        image: '/icons/trunk.png',
        video: '/solution/PassengerTrunk.mp4',
      },
      {
        name: 'Exterior',
        image: '/icons/exterior.png',
        video: '/solution/PassengerExterior.mp4',
      },
    ],
  },
  {
    ...
    videoSrc: '/solution/CommercialAlpha01.mp4',
    bottomControlsData: [
      {
        name: 'Complete Body',
        image: '/icons/commercial-body.svg',
        video: '/solution/CommercialAlpha01.mp4',
      },
      {
        name: 'Front',
        image: '/icons/commercial-engine.svg',
        video: '/solution/CommercialEngine.mp4',
      },
      {
        name: 'Cabin',
        image: '/icons/commercial-cabin.svg',
        video: '/solution/CommercialCabin.mp4',
      },
    ],
  },
];
...
const Solutions = () => {
  ...
  // STATE MANAGEMENT
  const [activeVehicleSection, setActiveVehicleSection] = useState<VehicleSection>(vehicleSectionsData[0]);
